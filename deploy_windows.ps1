...
if (Test-Path "ML_altcoin_trading_bot") {
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        Write-Host "⚠️ Git pull had issues. Continuing anyway..." -ForegroundColor Yellow
    }
} else {
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "⚠️ Some packages might have issues. Continuing..." -ForegroundColor Yellow
}
...
Write-Host "`n🎮 BOT CONTROL:" -ForegroundColor Cyan
